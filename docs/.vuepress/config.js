...
module.exports = {
    ...
    head: [
        [
            "link",
            { rel: "icon", href: `https://flutterwave.com/images/FLW-icon.png` }
        ],
        ...
        [
            "meta",
            { name: "twitter:url", content: "https://laravelrave.netlify.app/" }
        ],
        [
            "meta",
            {
        ...
        [
            "meta",
            { name: "og:url", content: "https://laravelrave.netlify.app/" }
        ],
        ...
        [
            "meta",
            {
                name: "twitter:title",
                content:
                    "Laravel Flutterwave 🦄🦄 | Integrate Flutterwave APIs seamlessly"
            }
        ],
        [
            ("meta",
    ...
    themeConfig: {
        ...
        sidebar: [
            ...
            },
            {
                title: "Payments",
                children: [
                    "/payments/payment-modal.html",
                    "/payments/webhook.html"
                ]
            }
        ],
